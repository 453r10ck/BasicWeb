...
<body>
    ...
    <!-- Edit form -->
    <form action="<?=PUBLIC_ROOT?>admin/edit_user/<?=$datas['id']?>" method="POST">
        <label for="username">Username</label> <br>
        <input type="text" name="username" value="<?=$datas['username']?>"> <br>

        <label for="email">Email</label> <br>
        <input type="email" name="email" value="<?=$datas['email']?>"> <br>

        <label for="phone">Phone</label> <br>
        <input type="text" name="phone" value="<?=$datas['phone']?>"> <br>

        <label for="address">Address</label> <br>
        <input type="text" name="address" value="<?=$datas['address']?>"> <br>
