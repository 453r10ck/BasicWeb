...
<body>
        ...
        <div class="navbar-container">
            ...
            <ul class="nav-menu" id="nav-menu">
                ...
                <?php if(!isset($_SESSION['user_id'])): ?> 
                    <li class="nav-item"><a href="<?=PUBLIC_ROOT?>public/login" class="nav-link">Login</a></li>
                <?php else: ?>
    ...
    <!-- Form -->
    <div class="container">
        <form action="<?=PUBLIC_ROOT?>post/create" method="POST" enctype="multipart/form-data">
            <label for="title">Title</label> <br>
            <input type="text" name="title" id="title" required> <br>

            <label for="content">Content</label> <br>
            <textarea name="content" id="content" cols="155" rows="30" required></textarea> <br>
